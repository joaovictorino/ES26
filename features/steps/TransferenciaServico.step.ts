...
class TransferenciaServicoStep {
  ...
  @given("a conta {string} com saldo {float} e a conta {string} com saldo de {float}")
  ...
  @then("o saldo da conta {string} deve ser {float} e a conta {string} deve estar com {float}")
